...
VerifierSudoku:
		...
		mov		x0, x19				// Param1: adresse de base du sudoku
		bl		VerifierR			// Branche au sous-programme de verification des rangees

		mov		x0, x19				// Param1: adresse de base du sudoku
		bl		VerifierC			// Branche au sous-programme de verification des colonnes

		mov		x0, x19				// Param1: adresse de base du sudoku
		bl		VerifierB			// Branche au sous-programme de verification des blocs

VerifierR:
		mov		x19, x0				// Conserve l'adresse du tableau dans x19
		mov		x20, NBLIGNES		// Nombre de lignes a verifier

VerifierRr:
		cbz		x20, VerifierC		// Si on a fini d'evaluer les rangees, branche a VerifierC
...
VerifierCc:
		cbz		x21, VerifierB		// Si on a fini d'evaluer les colonnes, branche a VerifierB
...
VerifierBb:
		cbz		x22, VerifierF		// Si on a fini d'evaluer les blocs, branche a VerifierF
...
/********************************************************************************
*  Sous-programme qui verifie l'integralite des rangees du sudoku	            *
*  x0: addresse du sudoku                                                       *
********************************************************************************/
VerifierRangee:
		SAVE						// Sauvegarde l'environnement de l'appelant
		...
		/* faire allumer/etiendre des bits de x25 */

		/*
		* si all 1's -> la rangee est valide, passer a la prochaine
		* sinon dispatch a sous-programme pour message d'erreur avec # de rangee
		*/
...
/********************************************************************************
*  Sous-programme qui verifie l'integralite des colonnes du sudoku	            *
*  x0: addresse du sudoku                                                       *
********************************************************************************/
VerifierColonne:
		SAVE						// Sauvegarde l'environnement de l'appelant
		...
		/*
		* si all 1's -> la rangee est valide, passer a la prochaine
		* sinon dispatch a sous-programme pour message d'erreur avec # de coloone
		*/
...
/********************************************************************************
*  Sous-programme qui verifie l'integralite des blocs du sudoku	             	*
*  x0: addresse du sudoku                                                       *
********************************************************************************/
VerifierBloc:
		SAVE						// Sauvegarde l'environnement de l'appelant
		...
		/*
		* si all 1's -> la rangee est valide, passer a la prochaine
		* sinon dispatch a sous-programme pour message d'erreur avec # de bloc
		*/
