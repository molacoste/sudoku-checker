...
/********************************************************************************
*  Sous-programme qui affiche le sudoku ligne par ligne				*
*  i = no de colonne, j = no ligne						*
*  Position de l'element courant: adr.base + [j * (nb.colonnes)+i]*4		*
*										*
*  x0: addresse du sudoku                                                       *
********************************************************************************/
AfficherSudoku:
		...
		/* S'occupe d'afficher les splitters pVerifierBloc40our serparer les blocs */
AfficherSudoku10:
		mov		x26, 3					// MOD
		udiv		x25, x21, x26
		mul		x26, x26, x25
		subs		x25, x21, x26
		cbz		x25, AfficherSudoku60
...
AfficherSudoku40:
		...
		b.lt		AfficherSudoku30			// Sinon, traite la ligne suivante
		...
		b.lt		AfficherSudoku10			// Sinon, traite la colonne suivante

		/* Affichage de la derniere barre verticale avec saut de ligne */
		adr		x0, splitter
		bl 		printf

		b.al 		AfficherSudoku70

		/* Fin boucle externe */

		/* Affiche un barre verticale */
AfficherSudoku50:
		adr		x0, barreVert
		bl 		printf
		b.al		AfficherSudoku40

		/* Afficher un splitter */
AfficherSudoku60:
		adr		x0, splitter
		bl 		printf
...
VerifierR10:
		cbz		x20, VerifierR20			// Si on a fini d'evaluer les rangees, branche a VerifierC
		...
		b.al		VerifierR10				// Revient a la boucle pour prochaine evaluation
...
VerifierC10:
		cbz		x21, VerifierC20			// Si on a fini d'evaluer les colonnes, branche a VerifierB
		...
		b.al		VerifierC10				// Revient a la boucle pour prochaine evalutation
...
VerifierB10:
		cbz		x22, VerifierB40			// Si on a fini d'evaluer les blocs, branche a VerifierF
		...
		cmp		x0, 1					// Regarde si on a un reste = 0
		b.ne		VerifierB30				// Si on a un reste, alors on doit seulement avancer de 12
...
VerifierB20:
		...
		b.al		VerifierB10				// Revient a la boucle pour prochaine evaluation
...
VerifierBloc:
		...
		mov 		x25, 0					// Bits pour verification init. a 0
		mov		x26, 1					// Bit pour faire verification avec eor
		mov		x24, 1					// Valeur "n" pour MOD

VerifierBloc10:
		cbz		x28, VerifierBloc30			// Si on a fini d'evaluer, on branche a VerifierBloc20
		...
		b.eq		VerifierBloc20				// Si oui, on branche a VerifierBloc20
...
* x0: n										*
* x1: d										*
* Retourne 1 s'il y a pas de reste, 0 sinon					*
********************************************************************************/
Modulo:
		SAVE
		...
		csel		x0, x21, x22, eq			// Si oui x0 = 1, sinon x0 = 0
